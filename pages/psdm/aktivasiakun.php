  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Akun</li>
        <li class="active">Aktivasi Akun</li>
      </ol>
    </section>
    ...
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Akun Belum Diaktivasi</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
              <?php include ('../include/aktivasi.php'); ?>
            </div>
          </div>
          <!-- /.box -->
...
<script type="text/javascript">
  ...
  function aktivasi(uname){
     if(confirm('Apakah anda yakin menghapus data ini ?')){
        window.location.href='../include/aktivasi.php?id='+uname;
        }
    }
</script>
</body>
